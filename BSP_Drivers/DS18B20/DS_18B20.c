...
#define ResetDQ() HAL_GPIO_WritePin(TEMP_GPIO_Port, TEMP_Pin, GPIO_PIN_RESET)
#define SetDQ()  	HAL_GPIO_WritePin(TEMP_GPIO_Port, TEMP_Pin, GPIO_PIN_SET)
#define GetDQ()  	HAL_GPIO_ReadPin(TEMP_GPIO_Port, TEMP_Pin) 

volatile float g_temp;		// ds18b20读取温度
...
float ds18b20_read(void)
{
	...
	g_temp = (float)((float)TemperatureData * 0.0625); //分辨率为0.0625度
